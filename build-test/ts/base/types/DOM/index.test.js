// @ts-ignore
import { ShadowDOMBaseElement, OpenShadowDOMBaseElement, ClosedShadowDOMBaseElement, } from './index.js';
describe('base.types.dom module', () => {
    const reifiedShadowDOMTemplateId = 'reified-element-template';
    const reifiedTemplate = `
...
`;
    ...
    test('its constructor attaches a shadow root with the contents of the specified template.', async () => {
        ...
        const element = document.createElement('reified-shadow');
        expect(element).not.toBeNull();
        const shadowDivElement = element?.shadowRoot?.querySelector?.('div') ?? null;
    ...
    it('defines an abstract base element for creating an open shadow root.', async () => {
        ...
        const element = document.createElement('open-reified-shadow');
        expect(element).not.toBeNull();
    ...
    it('defines an abstract base element for creating a closed shadow root.', async () => {
        ...
        const element = document.createElement('closed-reified-shadow');
        expect(element).not.toBeNull();
